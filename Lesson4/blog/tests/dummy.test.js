...
describe('total likes', () => {
	...
	test('when list has has multiple blogs, equals the likes of that', () => {
...
describe('favorite blog', () => {
	...
	test('When list has emany blogs, equals most popular', () => {
		assert.deepStrictEqual(
...
describe('most blog', () => {
	...
	test('When list has many blogs, equals most popular', () => {
		assert.deepStrictEqual(
...
describe('most likes', () => {
	...
	test('When list has many blogs, equals most likes', () => {
		assert.deepStrictEqual(
